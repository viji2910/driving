...
export default function services() {
  return (
    <Layout>
      <h1 className="text-4xl my-4 text-bold">
        Welcome to Your Road to Confidence – Class 5 and Class 7 Driving
        Teaching Services in Vancouver Lower Mainland!
      </h1>
      <p>
        Are you ready to navigate the roads of the Vancouver Lower Mainland with
        confidence? Look no further – our comprehensive Class 5 and Class 7
        driving instruction services are designed to empower learners of all
        levels, ensuring a safe and skilled driving experience.
      </p>
      ...
      <p>
        {" "}
        Based in the Vancouver Lower Mainland, our instructors bring in-depth
        knowledge of local roads, traffic patterns, and test routes. Gain a
        valuable edge by learning from those who understand the intricacies of
        driving in our beautiful region.
      </p>
      <h3 className="text-2xl my-4">Safety-Centric Approach:</h3>
      <p>
        {" "}
        Your safety is paramount. Our instructors prioritize defensive driving
        techniques, equipping you with the skills needed to handle diverse
        traffic scenarios confidently.
      </p>
      ...
      <p>
        Embark on your road to confidence with our Class 5 and Class 7 Driving
        Teaching Services. Contact us today to schedule your first lesson and
        experience the difference of learning with a dedicated and experienced
        driving instructor in the stunning Lower Mainland of Vancouver!
      </p>
    </Layout>
  );
}
